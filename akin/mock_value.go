...
type MockValue[T interface{}] struct {
	mock.Mock
}

// Comparable provides a mock function with given fields:
func (_m *MockValue[T]) Comparable() T {
	ret := _m.Called()
...
func (_m *MockValue[T]) Equals(_a0 T) boolean.Simple {
	ret := _m.Called(_a0)
...
func (_m *MockValue[T]) EqualsRaw(v T) boolean.Simple {
	ret := _m.Called(v)
...
func (_m *MockValue[T]) ExtractValues(cache acal.IValueCache) acal.IValueCache {
	ret := _m.Called(cache)
...
func (_m *MockValue[T]) GetAlias() string {
	ret := _m.Called()
...
func (_m *MockValue[T]) GetName() string {
	ret := _m.Called()
...
func (_m *MockValue[T]) GetTypedValue() T {
	ret := _m.Called()
...
func (_m *MockValue[T]) GetValue() interface{} {
	ret := _m.Called()
...
func (_m *MockValue[T]) HasIdentity() bool {
	ret := _m.Called()
...
func (_m *MockValue[T]) Identify() string {
	ret := _m.Called()
...
func (_m *MockValue[T]) IsNil() bool {
	ret := _m.Called()
...
func (_m *MockValue[T]) NotEquals(_a0 T) boolean.Simple {
	ret := _m.Called(_a0)
...
func (_m *MockValue[T]) NotEqualsRaw(v T) boolean.Simple {
	ret := _m.Called(v)
...
func (_m *MockValue[T]) SetAlias(_a0 string) {
	_m.Called(_a0)
}

// Stringify provides a mock function with given fields:
func (_m *MockValue[T]) Stringify() string {
	ret := _m.Called()
...
func (_m *MockValue[T]) ToSyntaxOperand(nextOp acal.Op) *acal.SyntaxOperand {
...
func NewMockValue[T interface{}](t mockConstructorTestingTNewMockValue) *MockValue[T] {
	mock := &MockValue[T]{}
	mock.Mock.Test(t)
