...
func (_m *MockInterface[T]) GetTypedValue() T {
	ret := _m.Called()
...
func (_m *MockInterface[T]) HasIdentity() bool {
	ret := _m.Called()
...
func (_m *MockInterface[T]) Identify() string {
	ret := _m.Called()
...
func (_m *MockInterface[T]) Stringify() string {
	ret := _m.Called()
